...
message(
    ...
    "Python:\t\t\t", reticulate::py_version(), "(", reticulate::py_exe(), ")", '\n',
...
```{r}
message(
    "hicstuff: \t", gsub('.*==', '', grep('hicstuff', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "chromosight: \t", gsub('.*==', '', grep('chromosight', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "cooler: \t", gsub('.*==', '', grep('cooler', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "pairtools: \t", gsub('.*==', '', grep('pairtools', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "numpy: \t", gsub('.*==', '', grep('numpy', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "samtools: \t", gsub('.*==', '', grep('samtools', HiCool:::HiCool_args$packages, value = TRUE)), "\n",
    "bowtie2: \t", gsub('.*==', '', grep('bowtie2', HiCool:::HiCool_args$packages, value = TRUE)), "\n"
)
```
...
```{r}
basilisk::listPackages(dirname(dirname(reticulate::py_exe())))
```
